...
import com.ranzn.cleanarchit.app.data.model.ResultsItem
import com.ranzn.cleanarchit.app.persentation.listners.OnItemClick
import com.ranzn.cleanarchit.databinding.CarouselItemLayoutBinding
import com.ranzn.cleanarchit.databinding.FeaturedItemLayoutBinding
import com.ranzn.cleanarchit.databinding.ItemLayoutBinding
import com.ranzn.cleanarchit.databinding.ShoppableItemLayoutBinding

class MainRecyclerViewAdapter(private val onItemClick: OnItemClick) : ListAdapter<ResultsItem, ViewHolder>(
    diffUtilCallBack
) {
